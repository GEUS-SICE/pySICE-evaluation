...
path_to_file = 'validation/data/PROMICE_OLCI_vALL.csv'
...
%run sice.py validation/data/PROMICE_OLCI_vALL.csv
# print(cmd)
# eval(cmd)
...
#%matplotlib qt
#%matplotlib inline  
# data_out = pd.read_csv('validation/data/S3_PROMICE_out.csv')
data_out = pd.read_csv('validation/data/S3_PROMICE_out.csv')
...
plt.tight_layout()
bl.stat_title(data_out['BBA_emp'], data_out['PROMICE_alb'],ax[1])
...
bl.stat_title(data_out[var], data_out['PROMICE_alb'],ax[2])
plt.tight_layout()
